...
class Appraisal(Base):
    ...
    review_model: Mapped[int] = mapped_column(SmallInteger, comment="评审类型")
    ...
    meeting_state: Mapped[int] = mapped_column(SmallInteger, default=10, index=True, comment="10待上会/20已上会")
